...
static const uint16_t SDM_CURRENT_RESETTABLE_TOTAL_ACTIVE_ENERGY = 0x0000;
static const uint16_t SDM_CURRENT_RESETTABLE_TOTAL_REACTIVE_ENERGY = 0x0000;
static const uint16_t SDM_CURRENT_RESETTABLE_IMPORT_ENERGY = 0x0000;
static const uint16_t SDM_CURRENT_RESETTABLE_EXPORT_ENERGY = 0x0000;
static const uint16_t SDM_IMPORT_POWER = 0x0000;
static const uint16_t SDM_EXPORT_POWER = 0x0000;
